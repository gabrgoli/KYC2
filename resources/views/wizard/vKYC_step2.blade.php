...
@section('title', 'Product vKYC Step 2')

@section('content')
    <div class="container">
        @include('layout_files.subheader-nowallet')

        <input type="hidden" id="userUUID" name="userUUID" value="{{$customer->UUID}}">
        <div class="row">
            <div class="col-md-12">
                Products vKYC Step 2
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        $(document).ready(function(){
            ...
            var interval = setInterval(function() {
                ...
                if (counter <= 0) {
                    ...
                    $('#counter').text(counter + ' until refresh.');
                }
            }, 1000);
