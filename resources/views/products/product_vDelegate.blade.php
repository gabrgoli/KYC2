...
@section('title', 'Product vDelegate')
...
@section('content')
    <div class="container">
        ...
        <div class="row mb-3">
            <div class="col-md-12 col-sm-12">
                vDELEGATE exist as Token in the your staking wallet. Stored in the
        ...
        <div class="row mb-5">
            <div class="col-md-12 col-sm-12">
                <ul>
                    ...
                    <li>an attribute indicating the regulatory jurisdiction of the WALLET (US, EU, etc.)</li>
                    <li>the staking address</li>
                </ul>
                <span class="hint">
                    <i>
        ...
        <div class="row mb-5">
            <div class="col-md-12 col-sm-12">
                <a href="{{ route('wizard.show', 'vDelegate') }}" class="btn btn-start">Start KYC for vDELEGATE</a>
            </div>
        </div>
