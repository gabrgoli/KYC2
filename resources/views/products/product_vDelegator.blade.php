...
@section('title', 'Product vDelegator')
...
@section('content')
    <div class="container">
        ...
        <div class="row mb-3">
            <div class="col-md-12 col-sm-12">
                vDELEGATOR exist as Token in the your staking wallet. Stored in the
        ...
        <div class="row mb-3">
            <div class="col-md-12 col-sm-12">
                ...
                <button class="btn-pill">An attribute indicating the regulatory jurisdiction of the POOL (US, EU,
                    etc.)</button>
                <button class="btn-pill">The staking address</button>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-md-12 col-sm-12">
        ...
        <div class="row mb-5">
            <div class="col-md-12 col-sm-12">
                <a href="{{ route('wizard.getStep1', 'vDELEGATOR') }}" class="btn btn-start">Start KYC for vDELEGATOR</a>
            </div>
        </div>
